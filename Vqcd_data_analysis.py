...
WL_avg = np.load('data/W_rt Ncf=10, t=[1-5], imp=False, smear=True.npy')
WL_avg_err = np.load('data/W_rt_err Ncf=10, t=[1-5], imp=False, smear=True.npy')

r_max = WL_avg.shape[1]
t_max = WL_avg.shape[0]

rad = np.load('data/radius Ncf=10, t=[1-5], imp=False, smear=True.npy')
